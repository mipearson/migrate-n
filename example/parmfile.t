################################################################################
# Parmfile for Migrate debug 3.0.7-x [do not remove these first TWO lines]
# generated automatically on
# Mon Jun  8 16:14:04 2009
#
...
#          population-relabel=YES:{assignment for each location in the infile}
#                example is population-relabel=YES:{1 2 2}
#          random-subset=number
...
theta=URANDOM: {0.000000 10.000000}
migration=FST
#
#-------------------------------------------------------------------------------
...
#        bayes-allfile=<YES:INTERVAL:FILENAME|NO>
#            FILENAME is the name of the file that will contain
...
bayes-priors= THETA UNIFORMPRIOR: 0.000000 20.000000 2.000000 
bayes-priors= MIG UNIFORMPRIOR: 0.000000 20.000000 2.000000 
#
long-chains=1
long-inc=200
long-sample=500
...
heating=NO
#YES:1:{1.000000,1.500000,3.000000,1000000.000000}
#
