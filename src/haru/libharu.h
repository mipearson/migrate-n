...
#define PDF_PAGE_WIDTH_LETTER   612
#define PDF_PAGE_HEIGHT_LETTER  792

#ifdef A4PAPER
#define PDF_DEFAULT_PAGE_WIDTH  PDF_PAGE_WIDTH_A4
#define PDF_DEFAULT_PAGE_HEIGHT PDF_PAGE_HEIGHT_A4
#else
#define PDF_DEFAULT_PAGE_WIDTH  PDF_PAGE_WIDTH_LETTER
#define PDF_DEFAULT_PAGE_HEIGHT PDF_PAGE_HEIGHT_LETTER
#endif
/*----------------------------------------------------------------------------*/
/*------ default values ------------------------------------------------------*/
