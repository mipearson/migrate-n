/*
 * << H a r u --free pdf library >> -- PdfCMap_GB_EUC_H.cc
 *
...
static const pdf_mb_unicode_map1 GB_EUC_H_UNICODE_ARRAY1[] = {
	{0xFF, 0xF8F5},
	{0x8140, 0x4E02},
	{0x8144, 0x4E0F},
	{0x8145, 0x4E12},
...
static const pdf_mb_unicode_map2 GB_EUC_H_UNICODE_ARRAY2[] = {
	{0x00, 0x80, 0x0000},
...
void
PdfCMap_GB_EUC_H::Init()
{
    AddCMap(CID_ARRAY1);
    SetCIDSystemInfo("Adobe", "GB1", 0);
    SetUnicodeArray(GB_EUC_H_UNICODE_ARRAY1, GB_EUC_H_UNICODE_ARRAY2);
}

void
PdfCMap_GB_EUC_H::ParseText(const char* text, pdf_byte_type* btype)
{
